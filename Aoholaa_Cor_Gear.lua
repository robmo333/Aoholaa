...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll = {main="Rostam",range="Compensator",
        head="Lanun Tricorne +3",neck="Regal Necklace",ear1="Etiolation Earring",ear2="Phawaylla Earring",
        body="Nyame Mail",hands="Chasseur's Gants +1",ring1="Defending Ring",ring2="Vertigo Ring",
        back={ name="Camulus's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Dual Wield"+10','Phys. dmg. taken-10%',}},
		waist="Flume Belt +1 +1",legs="Desultor Tassets",feet="Nyame Sollerets"}
    ...
    sets.precast.CorsairShot.Proc = {ammo="Eminent Bullet",
	...
	sets.precast.WS['Savage Blade'] = {head={ name="Herculean Helm", augments={'Accuracy+29','Weapon skill damage +5%',}},
    body="Nyame Mail", hands="Meg. Gloves +2", legs={ name="Herculean Trousers", augments={'Rng.Acc.+21','Weapon skill damage +5%','DEX+6','Attack+10',}},
    feet={ name="Herculean Boots", augments={'Accuracy+26','Weapon skill damage +5%','DEX+1','Attack+11',}}, neck={ name="Comm. Charm +2"},
    waist="Prosilio belt +1", left_ear={ name="Moonshade Earring"}, right_ear="Ishvara Earring", left_ring="Ifrit Ring +1",
    right_ring="Ifrit Ring +1", back={ name="Camulus's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}}
    ...
    sets.precast.WS['Burning Blade'] = {ammo="Eminent Bullet",
    ...
    -- Ranged gear
    sets.midcast.RA = {ammo="Eminent Bullet",
    ...
    sets.midcast.RA.Acc = {ammo="Eminent Bullet",
        head="Meghanada Visor +2",neck="Iskur Gorget",ear1="Enervating Earring",ear2="Telos Earring",
        body="Laksa. Frac +3",hands="Meg. Gloves +2",ring1="Regal Ring",ring2="Dingir Ring",
    ...
    -- Idle sets
    sets.idle = {ammo="Eminent Bullet",
        head="Nyame Helm",body="Nyame Mail",hands="Nyame Gauntlets",legs="Nyame Flanchard",
		feet="Nyame Sollerets",neck="Dampener's Torque",waist="Flume Belt +1",left_ear="Etiolation Earring",
		right_ear="Phawaylla Earring",left_ring="Defending Ring",right_ring="Vertigo Ring",back="Moonbeam Cape"}
		
    sets.idle.Refresh = {ammo="Eminent Bullet",
        ...
        back="Moonbeam Cape",waist="Flume Belt +1",legs="Rawhide Trousers",feet=gear.herculean_dt_feet}
    
    -- Defense sets
    sets.defense.PDT = {ammo="Eminent Bullet",
        head="Meghanada Visor +2",neck="Loricate Torque +1",ear1="Genmei Earring",ear2="Sanare Earring",
        body="Meg. Cuirie +2",hands=gear.herculean_dt_hands,ring1="Defending Ring",ring2="Dark Ring",
        back="Moonbeam Cape",waist="Flume Belt +1",legs="Meg. Chausses +2",feet=gear.herculean_dt_feet}

    sets.defense.MDT = {ammo="Eminent Bullet",
    ...
    sets.defense.MEVA = {ammo="Eminent Bullet",
        head="Meghanada Visor +2",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Sanare Earring",
        body="Meg. Cuirie +2",hands=gear.herculean_dt_hands,ring1="Defending Ring",ring2="Dark Ring",
        back="Moonbeam Cape",waist="Flume Belt +1",legs="Meg. Chausses +2",feet="Ahosi Leggings"}
    ...
    -- Normal melee group
    sets.engaged = {
    head={ name="Adhemar Bonnet +1"}, body={ name="Adhemar Jacket +1"}, hands={ name="Adhemar Wrist. +1", augments={'DEX+12','AGI+12','Accuracy+20',}},
    legs={ name="Carmine Cuisses +1"}, feet={ name="Herculean Boots", augments={'Accuracy+21','"Triple Atk."+4','DEX+4',}},
    neck="Iskur Gorget", waist="Windbuffet Belt +1", left_ear="Mache Earring +1", right_ear="Suppanomimi", left_ring="Petrov Ring",
    right_ring="Epona's Ring", back={ name="Camulus's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Dual Wield"+10','Phys. dmg. taken-10%',}}}
